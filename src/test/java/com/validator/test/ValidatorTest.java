...
public class ValidatorTest extends ValidatorTestUtilities {
	...
	ValidationDataFromJDBC databaseDataGatherer;
	...
	public Object[] validateDateTestInvalidParams() {
		return new Object[] { new Object[] { "32/01/2016 00:00" }, new Object[] { "-01/01/2015 00:01" },
				...
				new Object[] { getDatesInTheFuture(1) }, new Object[] { getDatesInTheFuture(2) },
				new Object[] { getDatesInTheFuture(3) }, new Object[] { getDatesInTheFuture(4) },
				new Object[] { getDatesInTheFuture(5) }, new Object[] { "29/02/1900 16:00" } };
	}

	@Parameters
	public Object[] validateEventIdParams() {
		return new Object[] { new Object[] { 4097.0 }, new Object[] { 4098.0 }, new Object[] { 4125.0 },
				new Object[] { 4106.0 } };
	}
	...
	public void setUp() {
		try {
			databaseDataGatherer = new ValidationDataFromJDBC();
			validEventIds = databaseDataGatherer.getEventIdList();
